...
export default function Footer({ backgroundColor, textColor }: FooterProps) {
  return (
    <>
      <div
        // className={` ${backgroundColor} px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-full md:px-24 lg:px-8`}
        className={` ${backgroundColor} px-4 pt-16 mx-auto md:px-24 lg:px-8`}
      >
        <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
          <div className="sm:col-span-2">
            <h1 className=" text-2xl text-gray-900  ">
              <span
                className={`italic font-bold text-[tomato] text-3xl pr-2 ${textColor}`}
              >
                NOHAMA
              </span>
              Pest Control
        ...
        <div className="flex flex-col-reverse justify-between pt-5 pb-10 border-t lg:flex-row">
          <p className="text-sm text-gray-900">
            © Copyright 2024 Nohama Inc. All rights reserved.
          </p>
